  ...
  render() {
    if (this.state.hasError) {
      return <div style={{ color: "red", padding: 20, background: "black", position: "absolute", inset: 0, zIndex: 9999 }}>
        <h2>Lab Crashed!</h2>
        <pre style={{ fontSize: 20, whiteSpace: "pre-wrap" }}>{this.state.error?.toString()}</pre>
...
function Chalkboard({ stats, isNear, chalkCol }) {
  ...
  return (
    ...
    <div onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} style={{
      ...
      {/* Chalk header */}
      <div style={{ fontSize: 8.5, textAlign: "center", borderBottom: "1px dashed rgba(196,232,188,0.2)", paddingBottom: 2, marginBottom: 3, opacity: 0.8 }}>
        EXPERIMENTS LOG
      </div>
      {/* Stats */}
      ...
      <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`} style={{ overflow: "visible" }}>
        ...
        {years.map((yearData, yearIndex) => {
          ...
          return (
            <g key={yearData.year}>
              {/* Year label */}
              <text x={0} y={baseY - 2} fill="rgba(196,232,188,0.5)" fontSize={5} fontFamily="'Micro 5', monospace">{yearData.year}</text>
              {/* Heartbeat line */}
    ...
    >
      ...
      >
        <div style={{ width: "100%", display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
          <div>
            <div style={{ color: "#c4e8bc", fontSize: 12, fontFamily: "'Micro 5', monospace" }}>GITHUB ACTIVITY</div>
            <a href="https://github.com/saad-ibra" target="_blank" rel="noopener noreferrer" style={{ color: "#b0f0b8", fontSize: 12, textDecoration: "underline", fontFamily: "'Micro 5', monospace", marginTop: 6, display: "block" }}>
          ...
          {!commitStats ? (
            <div style={{ height: height, display: "flex", alignItems: "center", justifyContent: "center", color: "#c4e8bc", fontSize: 10, animation: "dialogBlink 1s infinite" }}>
              ANALYZING COMMITS...
            </div>
          ) : commitStats.error ? (
            <div style={{ height: height, display: "flex", alignItems: "center", justifyContent: "center", color: "#ff8888", fontSize: 8, textAlign: "center", lineHeight: "8px" }}>
              VITE_GITHUB_TOKEN REQUIRED<br/><br/>(ADD TO .env FOR EKG)
            </div>
          ) : (
            <>
              {renderEKG()}
              <div style={{ display: "flex", justifyContent: "space-between", color: "rgba(196,232,188,0.5)", fontSize: 8, fontFamily: "'Micro 5', monospace", marginTop: 4 }}>
                <span>JAN</span>
                <span>DEC</span>
              </div>
            </>
        ...
        {commitStats && !commitStats.error && commitStats.maxMonth && (
          <div style={{ color: "#ffd060", fontSize: 8, fontFamily: "'Micro 5', monospace", marginTop: 12, textAlign: "center", opacity: 0.8 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {isPriv ? (
            ...
            <div style={{
              fontSize: 6, color: glow, fontFamily: "'Micro 5', monospace",
          ...
          {phase !== "free" && (
            <div style={{
              ...
              <div style={{
                ...
                padding: "2px 8px", fontSize: 14, color: "#80c8a0", borderRadius: 2,
              }}>SAAD IBRA</div>
              <div style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 16, lineHeight: 2.4, minHeight: 28, color: "#eef7f2" }}>
                  ...
                  <div style={{ marginTop: 8 }}>
                    ...
                    >
                      <span style={{ fontSize: 10, color: "#a8e8a8", marginRight: 8, background: "rgba(0,0,0,0.2)", padding: "2px 4px", borderRadius: 2 }}>SPACE/A</span>
                      ENTER LAB
                    </button>
                  </div>
                </div>
            ...
            >
              ...
              >
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: 12.5, color: "#fff", maxWidth: 200, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <div style={{ padding: "12px 14px", display: "flex", flexDirection: "column", gap: 10 }}>
                  {openStationData.isPrivate ? (
                    <>
                      <div style={{ fontSize: 10.5, color: "#ff8080", textAlign: "center" }}>ACCESS RESTRICTED</div>
                      <div style={{ fontSize: 8.5, color: "#7090a0", textAlign: "center", lineHeight: "9px" }}>
                    ...
                    <>
                      {openStationData.repoData?.description && (
                        <div style={{ fontSize: 8.5, color: "#90b8c8", lineHeight: "9px" }}>
                          {openStationData.repoData.description}
                        </div>
                      )}
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        {openStationData.repoData?.language && (
                          <span style={{ fontSize: 10, color: "#60889a" }}>
                            {openStationData.repoData.language}
                          </span>
                        )}
                        {openStationData.repoData?.stars > 0 && (
                          <span style={{ fontSize: 10, color: "#ffd060", display: "flex", alignItems: "center", gap: 4 }}>
